...
openai.api_key = "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"

client = weaviate.Client(
    url = "https://gautamn-sandbox-347iuucy.weaviate.network/",  # Replace with your endpoint
    additional_headers = {
        "X-OpenAI-Api-Key": "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"  # Replace with your inference API key
    }
)
